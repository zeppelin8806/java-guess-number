...
public class ChallengeCheckingAccountTest {
    ...
    public void test01_CheckingAccountClassWellFormed() {
        try {
            ...
            assertEquals("CheckingAccount must override BankAccount withdraw(BigDecimal) method. Make sure access for the method is public.", "com.techelevator.CheckingAccount", withdrawMethod.getDeclaringClass().getName());
            ...
            assertEquals("CheckingAccount must not redefine deposit(BigDecimal).", "com.techelevator.BankAccount", depositMethod.getDeclaringClass().getName());
