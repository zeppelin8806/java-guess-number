...
public class ChallengeSavingsAccountTest {
    ...
    public void test01_SavingsAccountClassWellFormed() {
        try {
            ...
            assertEquals("SavingsAccount must override BankAccount withdraw(BigDecimal) method. Make sure access for the method is public.", "com.techelevator.SavingsAccount", withdrawMethod.getDeclaringClass().getName());
