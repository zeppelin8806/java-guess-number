...
You've been hired as a new developer at Acme Inc. As such, you have inherited some [legacy code][what-is-legacy-code] that doesn't have any unit tests. 
Your job is to create unit tests for all classes. 

If a defect is encountered, you should document the bug on the test-results.txt file. There are a total of six
defects. After documenting and identifying the defect, fix the production code.

Your code will be evaluated based on the following criteria:

* The project must not have any build errors.
* You documented the correct bugs on test-results.txt (again, there are 6 bugs)
* Unit tests pass as expected after the fixes have been performed.
...
3. For each method, familiarize yourself with the description of the problem written on the comment block. This description represents what the code is supposed to do, and our tests will check if the code actually does that.
